...
# ==============================================================================
# Comprehensive Linux Mint Setup Script for ASUS ROG Flow Z13 (2025, GZ302)
#
# Author: th3cavalry using Copilot
# Version: 1.5
#
# This script automates the post-installation setup for Linux Mint on the
...
#
# PRE-REQUISITES:
# 1. A base installation of Linux Mint (21.x or newer).
# 2. An active internet connection.
# 3. A user with sudo privileges.
#
# USAGE:
# 1. Download the script:
#    curl -O https://raw.githubusercontent.com/th3cavalry/GZ302-Arch-Setup/main/linuxmint_setup.sh
# 2. Make it executable:
#    chmod +x linuxmint_setup.sh
# 3. Run with sudo:
#    sudo ./linuxmint_setup.sh
# ==============================================================================
...
setup_repositories() {
    ...
    # Install Flatpak support (Linux Mint may not have it by default)
...
install_gaming_stack() {
    ...
    # For Linux Mint, we'll use the official Steam package
    ...
    apt install -y lutris || {
        warning "Lutris not available in standard repos, adding PPA..."
    ...
    apt install -y mangohud || {
        warning "MangoHUD not available in standard repos, installing via Flatpak..."
...
main() {
    ...
    info "This script will configure your Linux Mint system for optimal ROG Flow Z13 performance"
    ...
    success ""
    success "You can now enjoy Linux Mint optimized for your"
